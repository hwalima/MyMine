...
def fix_energy_usage_data(apps, schema_editor):
    ...
    while current_date <= end_date:
        ...
        # More realistic base values for a medium-sized mining operation
        base_electricity = Decimal('2000') * growth_factor  # Base electricity in kWh
        base_diesel = Decimal('900') * growth_factor       # Base diesel in liters
        ...
        # Calculate costs (electricity at $1.50 per kWh, diesel at $2.00 per liter)
        electricity_cost = electricity_kwh * Decimal('1.50')
...
class Migration(migrations.Migration):
    dependencies = [
        ('mining_operations', '0036_fix_energy_usage_data_decimal'),
    ]
